...
<?php echo $this->Form->create('Mfcountdate'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Mfcountdate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Mfcountdate.DateID')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Mfcountdate.DateID'))); ?></li>
